...
.NOTES 
    File Name  : Grant-AppSuiteKeyVaultTest.ps1
               :
    ...
    Get-Help ./Grant-AppSuiteKeyVaultTest.ps1 [Null], [-Full], [-Detailed], [-Examples]
...
.PARAMETER AzureKeyVaultName
    Example: "sasdcs"
.EXAMPLE
    ./Grant-AppSuiteKeyVaultTest.ps1 -Subscription "AppSuite" -AzureRegion "East US 2" -AzureRGName "Test_Common" -AzureKeyVaultName "sastcs" -Verbose
.EXAMPLE
    ./Grant-AppSuiteKeyVaultTest.ps1 "AppSuite" "East US 2" "Test_Common" "sastcs" -Verbose
.INPUTS
...
# Azure AD AppSuiteKeyVaultTest ClientID/Key as stored in KeePass.  These values should probably end up in Key Vault itself instead.  Backlog task.
$AADClientID = "b1fc2490-5bed-4103-9a4e-bcc98ae5325b"
$AADKey = "lSl1ROvRzhZM5h2+7YWWo6wuy62fakxBKOfEVlpZ3H8="
...
{
    $Found = $KV.AccessPolicies[$Count].DisplayName -like "AppSuiteKeyVaultTest*"
    If ($Found)
    {
...
If ($KV.EnabledForDiskEncryption)
{
    ...
    # Grant AppSuiteKeyVaultTest access with full control to manage Key Vault.
