...
.DESCRIPTION 
    This enables Bitlocker on the specified VM by using the AppSuiteBitlockerProd Azure AD Applicaiton AuthZ (previously granted)
	to the sasdcs Key Vault, to store the BEK after it has been created by the Azure VM Extension.

.NOTES 
    File Name  : Enable-AppSuiteBitlockerProd.ps1
               :
    ...
    Get-Help ./Enable-AppSuiteBitlockerProd.ps1 [Null], [-Full], [-Detailed], [-Examples]
...
.PARAMETER VMName
    Example: "SSAS-PRD01"
.EXAMPLE
    ./Enable-AppSuiteBitlockerProd.ps1 -Subscription "AppSuite" -AzureRegion "East US 2" -AzureRGName "Production_Common" -AzureKeyVaultName "saspcs" -VMName "SSAS-PRD01" -Verbose
.EXAMPLE
    ./Enable-AppSuiteBitlockerProd.ps1 "AppSuite" "East US 2" "Production_Common" "saspcs" -VMName "SSAS-PRD01" -Verbose
.INPUTS
