...
.DESCRIPTION 
    This enables Bitlocker on the specified VM by using the AppSuiteBitlockerStage Azure AD Applicaiton AuthZ (previously granted)
	to the sasdcs Key Vault, to store the BEK after it has been created by the Azure VM Extension.

.NOTES 
    File Name  : Enable-AppSuiteBitlockerStage.ps1
               :
    ...
    Get-Help ./Enable-AppSuiteBitlockerStage.ps1 [Null], [-Full], [-Detailed], [-Examples]
...
.PARAMETER VMName
    Example: "SSAS-STG01"
.EXAMPLE
    ./Enable-AppSuiteBitlockerStage.ps1 -Subscription "AppSuite" -AzureRegion "East US 2" -AzureRGName "Stage_Common" -AzureKeyVaultName "sasdcs" -VMName "SSAS-STG01" -Verbose
.EXAMPLE
    ./Enable-AppSuiteBitlockerStage.ps1 "AppSuite" "East US 2" "Stage_Common" "sasdcs" -VMName "SSAS-STG01" -Verbose
.INPUTS
...
[string]$AzureKeyVaultName = "sasscs"
[string]$VMName = "SSAS-STG01"
