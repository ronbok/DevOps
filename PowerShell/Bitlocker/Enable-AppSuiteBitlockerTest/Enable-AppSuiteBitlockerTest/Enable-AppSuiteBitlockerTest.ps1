...
.DESCRIPTION 
    This enables Bitlocker on the specified VM by using the AppSuiteBitlockerTest Azure AD Applicaiton AuthZ (previously granted)
	to the sasdcs Key Vault, to store the BEK after it has been created by the Azure VM Extension.

.NOTES 
    File Name  : Enable-AppSuiteBitlockerTest.ps1
               :
    ...
    Get-Help ./Enable-AppSuiteBitlockerTest.ps1 [Null], [-Full], [-Detailed], [-Examples]
...
.PARAMETER VMName
    Example: "SSAS-TST01"
.EXAMPLE
    ./Enable-AppSuiteBitlockerTest.ps1 -Subscription "AppSuite" -AzureRegion "East US 2" -AzureRGName "Test_Common" -AzureKeyVaultName "sasdcs" -VMName "SSAS-TST01" -Verbose
.EXAMPLE
    ./Enable-AppSuiteBitlockerTest.ps1 "AppSuite" "East US 2" "Test_Common" "sasdcs" -VMName "SSAS-TST01" -Verbose
.INPUTS
