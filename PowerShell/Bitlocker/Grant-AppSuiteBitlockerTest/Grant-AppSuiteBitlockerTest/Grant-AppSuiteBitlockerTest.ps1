...
.SYNOPSIS 
    ...
    already exists by the name AppSuiteBitlockTest and the following code uses these values of ClientID/Key from that
    specific application instance.
.DESCRIPTION 
    This grants Azure Key Vault permissions to an Azure AD Application previously registered.

.NOTES 
    File Name  : Grant-AppSuiteBitlockerTest.ps1
               :
    ...
    Get-Help ./Grant-AppSuiteBitlockerTest.ps1 [Null], [-Full], [-Detailed], [-Examples]
...
.PARAMETER AzureKeyVaultName
    Example: "sastcs"
.EXAMPLE
    ./Grant-AppSuiteBitlockerTest.ps1 -Subscription "AppSuite" -AzureRegion "East US 2" -AzureRGName "Test_Common" -AzureKeyVaultName "sastcs" -Verbose
.EXAMPLE
    ./Grant-AppSuiteBitlockerTest.ps1 "AppSuite" "East US 2" "Test_Common" "sastcs" -Verbose
.INPUTS
...
$AADClientID = "bbf88cc7-1884-4d68-9b80-a0769132f903"
$AADKey = "4TU91THm9yNQ3wi7n3n9fK19v37NuSB9FzPodgGCvCc="
...
{
    $Found = $KV.AccessPolicies[$Count].DisplayName -like "AppSuiteBitlockerTest*"
    If ($Found)
    {
...
If ($KV.EnabledForDiskEncryption)
{
    ...
    # Grant AppSuiteBitlockerTest access with full control to manage Key Vault.
